...
<tr>
<td>NOM</td>
<td><form:input type="text" path="name" value="${category.name}"/></td>
</tr>
<tr>
<td>Description</td>
<td><form:input type="text" path="description" value="${category.description}"/></td>
</tr>
<tr>
<td>Disabled</td>
<td><form:input type="text" path="country" value="${category.disabled}"/></td>
</tr>
