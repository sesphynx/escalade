...
<tr>
<td>Id:</td><td><input type="text" name="id" value="${commande.id}" />
</td>
</tr>
...
<tr>
<td>Client</td> <td> <form:input type="client" path="client" value="${commande.client.name}" /></td>
</tr>

<tr>
<td>Order Number</td><td> <form:input type="text" path="orderNumber" value="${commande.orderNumber}"/></td>
</tr>
<tr>
<td>Cree Le</td><td> <form:input type="text" path="createdOn" value="${commande.createdOn}"/></td>
</tr>
<tr>
<td>ADDRESSE LIVRAISON</td><td> <form:input type="addresse" path="addresseLivraison"  value="${commande.adresseLivraison}"/></td>
</tr>
<tr>
<td>ADDRESSE FACTURATION</td><td> <form:input type="addresse" path="addresseFacturation" value="${commande.addresseFacturation}"/></td>
</tr>
<tr>
<td>Payment</td> <td> <form:input type="payment" path="payment" value="${commande.payment}" /></td>
</tr>

<tr>
<td>Etat</td><td> <form:input type="text" path="orderNumber" value="${commande.etat}"/></td>
</tr>
<tr>
