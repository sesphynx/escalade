...
public class ProspectExcell extends AbstractEntity {
	 ...
	 * @param numeroF
	 */
	public ProspectExcell(Prospectus prospectus, String addresse, String nom, String prenom, String mail, String numeroM,
			String numeroF) {
	...
	public int hashCode() {
		...
		result = prime * result + ((codification == null) ? 0 : codification.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ProspectExcell other = (ProspectExcell) obj;
		if (addresse == null) {
		...
		if (codification == null) {
			if (other.codification != null)
				return false;
		} else if (!codification.equals(other.codification))
			return false;
		if (mail == null) {
			if (other.mail != null)
				return false;
	...
	public String toString() {
		return "ProspectExcell [rowIndex=" + rowIndex + ", addresse=" + addresse + ", nom=" + nom + ", prenom=" + prenom
				+ ", mail=" + mail + ", numeroM=" + numeroM + ", numeroF=" + numeroF + "]";
	}
