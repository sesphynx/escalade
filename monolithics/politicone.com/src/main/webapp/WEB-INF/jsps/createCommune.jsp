...
<table>
<tr> 
<td>Ville</td>  <td> </td> <td><form:select  path="ville">
<form:option value="" label="Selectionner"/>
<form:options items="${villes}"  itemLabel="nom" itemValue="id"/></form:select></td>
</tr>
<br></br>
<tr> 
<td>NOM</td>  <td> </td>  <td> <form:input type="text" path="nom"/></td>
 ...
 <br></br>
<tr> 
<td></td>  <td colspan="2"> <input type="submit" value="SAUVER" /> </td>  <td></td>
</tr>
</table>
</form:form>
